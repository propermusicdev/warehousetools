 ...
 */
public class zzUpdateMoveLineFragment extends Fragment {
    private String TAG = zzUpdateMoveLineFragment.class.getSimpleName();
    ...
    public zzUpdateMoveLineFragment() {
        if (mActivity == null) {
                        ...
                        int value = Integer.parseInt(s.toString());
                            if (value > 0) {
                                if (value <= moveline.getQty()) {
                                    ...
                                    AlertDialog.Builder builder = new AlertDialog.Builder(zzUpdateMoveLineFragment.this.getActivity());
